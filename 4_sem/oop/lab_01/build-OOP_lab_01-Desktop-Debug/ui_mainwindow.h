...
public:
    ...
    QLabel *save_label;
    QLineEdit *save_file_lineEdit;
    QPushButton *save_file_pushButton;
    QFrame *frame_2;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        sizePolicy1.setHeightForWidth(center_z_lineEdit->sizePolicy().hasHeightForWidth());
        center_z_lineEdit->setSizePolicy(sizePolicy1);
        ...
        sizePolicy2.setHeightForWidth(scale_pushButton->sizePolicy().hasHeightForWidth());
        scale_pushButton->setSizePolicy(sizePolicy2);
        ...
        frame_6->setMaximumSize(QSize(190, 16777215));
        frame_6->setFrameShape(QFrame::StyledPanel);
        frame_6->setFrameShadow(QFrame::Raised);
        verticalLayout = new QVBoxLayout(frame_6);
        verticalLayout->setObjectName(QString::fromUtf8("verticalLayout"));
        save_label = new QLabel(frame_6);
        save_label->setObjectName(QString::fromUtf8("save_label"));
        save_label->setMaximumSize(QSize(200, 16777215));

        verticalLayout->addWidget(save_label);

        save_file_lineEdit = new QLineEdit(frame_6);
        save_file_lineEdit->setObjectName(QString::fromUtf8("save_file_lineEdit"));
        save_file_lineEdit->setMaximumSize(QSize(200, 16777215));

        verticalLayout->addWidget(save_file_lineEdit);

        save_file_pushButton = new QPushButton(frame_6);
        save_file_pushButton->setObjectName(QString::fromUtf8("save_file_pushButton"));
        save_file_pushButton->setMaximumSize(QSize(200, 16777215));

        verticalLayout->addWidget(save_file_pushButton);


        gridLayout_5->addWidget(frame_6, 5, 0, 1, 1);
        ...
        sizePolicy1.setHeightForWidth(move_z_lineEdit->sizePolicy().hasHeightForWidth());
        move_z_lineEdit->setSizePolicy(sizePolicy1);
        ...
        gridLayout_5->addWidget(rc_label, 7, 0, 1, 2);
        ...
        gridLayout_5->addWidget(widget, 0, 1, 6, 1);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        rotate_pushButton->setShortcut(QCoreApplication::translate("MainWindow", "R", nullptr));
        ...
        read_file_pushButton->setText(QCoreApplication::translate("MainWindow", "\320\227\320\260\320\263\321\200\321\203\320\267\320\270\321\202\321\214", nullptr));
#if QT_CONFIG(shortcut)
        read_file_pushButton->setShortcut(QCoreApplication::translate("MainWindow", "L", nullptr));
#endif // QT_CONFIG(shortcut)
...
#if QT_CONFIG(shortcut)
        scale_pushButton->setShortcut(QCoreApplication::translate("MainWindow", "S", nullptr));
#endif // QT_CONFIG(shortcut)
        save_label->setText(QCoreApplication::translate("MainWindow", "\320\241\320\276\321\205\321\200\320\260\320\275\320\270\321\202\321\214 \320\262 \321\204\320\260\320\271\320\273", nullptr));
        save_file_pushButton->setText(QCoreApplication::translate("MainWindow", "\320\241\320\276\321\205\321\200\320\260\320\275\320\270\321\202\321\214", nullptr));
#if QT_CONFIG(shortcut)
        save_file_pushButton->setShortcut(QCoreApplication::translate("MainWindow", "L", nullptr));
#endif // QT_CONFIG(shortcut)
...
#if QT_CONFIG(shortcut)
        move_pushButton->setShortcut(QCoreApplication::translate("MainWindow", "M", nullptr));
#endif // QT_CONFIG(shortcut)
